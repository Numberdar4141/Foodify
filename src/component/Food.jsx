...
<div className=" bg-gray-300 mb-[40px] grid place-content-center ml-[500px] rounded-3xl  w-[370px] ">
...
<div>
        ...
        Show More <KeyboardArrowDownIcon className="mr-[1px] text-[50px] mb-[7px]"/>
      </button>
          </Link> 
