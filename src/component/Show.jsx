...
const Home = () => {
    ...
    return (
        < >
            ...
            <div   className=" place-content-top bg-white  border-gray-100 h-auto   grid place-content-center  ">


<div className="grid place-content-center h-auto   w-[400px] ">    
           <div className="  p-4 w-[1380px]  h-auto  ">
           
           
    <div>
        <div className="  flex flex-wrap width-[100%] h-auto   flex-row   p-1">
            <div className=" flex w-[200px] h-[220px] hover:rounded-lg hover:scale-105 border-2 hover:border-slate-300 p-4 m-8 rounded-3xl  shadow-xl hover:shadow-2xl     bg-white">
               
            <Link to = "/Buy">
                
                <img className="h-[160px] rounded-full  " src={Home1} alt="" srcset="" />
                <h3 className=" text-black ml-[20px] font-medium ">Iphone 15 Pro Max</h3>
            </Link>

            </div>
            <div className=" flex w-[200px] h-[220px] hover:scale-105 border-2 hover:border-slate-300 p-4 m-8 rounded-3xl hover:rounded-lg  shadow-xl hover:shadow-2xl     bg-white">
...
<div className=" bg-gray-300 mb-[40px] grid place-content-center ml-[500px] rounded-3xl hover:rounded-lg w-[370px] ">
...
<div>
      <button className="btn border-2 hover:rounded-lg h-[50px]  rounded-3xl w-[100px] bg-gray-300 ml-[10px]   ">
        Filters<FilterAltIcon className="mr-[1px]  text-[50px] mb-[2px]"/>
      </button>
    </div>
    <div>
      <button className="btn border-2 hover:rounded-lg h-[50px]  rounded-3xl w-[130px] bg-gray-300 ml-[20px]   ">
        Rating 4.0+ <ThumbUpIcon className="mr-[1px] text-[50px] mb-[2px]"/>
      </button>
    </div>
    <div>
      <button className="btn border-2 hover:rounded-lg h-[50px]  rounded-3xl w-[120px] bg-gray-300 ml-[20px]   ">
        Pure Veg <KeyboardArrowDownIcon className="mr-[1px] text-[50px] mb-[7px]"/>
      </button>
    </div>
    <div>
      <button className="btn border-2 hover:rounded-lg  h-[50px]   rounded-3xl w-[100px] bg-gray-300 ml-[20px]   ">
        Cuisines<KeyboardArrowDownIcon className="mr-[1px] text-[50px] mb-[7px]"/>
      </button>
    </div>
<div>
      <button className="btn border-2 hover:rounded-lg h-[50px]  rounded-3xl w-[100px] bg-gray-300 ml-[600px]   ">
...
<div>
            ...
            <div className=" bg-gray-50 h-[200px] w-screen">
                
            <div>
                <Link to ="/Food">
            <button className="btn border-2 hover:rounded-lg mt-[120px] rounded-3xl w-[150px] bg-gray-300 ml-[610px]   ">
        Show Less <KeyboardArrowDownIcon className="mr-[1px] text-[50px] mb-[7px]"/>
      </button>
                </Link>
